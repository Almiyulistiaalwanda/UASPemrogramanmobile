...
public class DaftarHewanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } else if (hewans.get(0) instanceof Serigala) {
            judul = getString(R.string.serigala_list_title);
        } else if (hewans.get(0) instanceof Rusa) {
            judul = getString(R.string.rusa_list_title);
        }
